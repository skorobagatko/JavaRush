...
public class Solution
{
    ...
    static class HenFactory {
        ...
        static Hen getHen(String country) {
            ...
            else if (Country.UKRAINE.equals(country)) { return new UkrainianHen(); }
            else if (Country.MOLDOVA.equals(country)) { return new MoldovanHen(); }
            else if (Country.BELARUS.equals(country)) { return new BelarusianHen(); }
            return null;
        }
    }
}
